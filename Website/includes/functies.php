...
function genereerArtikelen($dbh, $gegevenQuery, $columntype) {     
    ...
    while ($row = $queryvoorwerpen->fetch()) {
        ...
        $artikelen .= '<div id = "hover" class=" ' . $columntype . ' tile" prijs-hover='. "€" .  $Verkoopprijs . ' >
                <a href = "voorwerppagina.php?voorwerpID=' .$voorwerpNummer . '" class="d-flex flex-column justify-content-between align-content-start"style="height: 149px;background-image: url(assets/img/' . $foto . '); background-size: cover" >
