...
<!-- Formulier registreren emailadres -->
...
<div style="height: 600px;">
    <div class="login-dark" style="background-color: #3a3a3a;height: 601px;">
        <form method="post" style="background-color: #4b4c4d;" action="#">
            ...
            <div class="form-group"><p>E-mailadres</p><input class="form-control" type="email" name="Emailadres" placeholder="E-mailadres"></div>
