    ...
    <main style="min-height: 52.5vh;margin-right: 10vw;margin-left: 10vw;">
        <div class="container text-center">
            ...
            <form class="text-left" style="width: 100%;" method="post" action="registreren_pagina.php">
                <h5 class="text-left text-sm-left text-md-left text-lg-left text-xl-left">Voornaam*</h5>
                ...
                <h5 class="text-Left text-sm-Left text-md-Left text-lg-Left text-xl-Left">Achternaam*</h5>
        ...
        <h5 class="text-Left text-sm-Left text-md-Left text-lg-Left text-xl-Left">Geboortedatum*</h5>
        ...
        <h5 class="text-Left text-sm-Left text-md-Left text-lg-Left text-xl-Left">Telefoonnummer*</h5>
        ...
        <h5 class="text-Left text-sm-Left text-md-Left text-lg-Left text-xl-Left">Adres 1*</h5>
        ...
        <h5 class="text-Left text-sm-Left text-md-Left text-lg-Left text-xl-Left">Adresregel 2</h5>
        <div class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center flex-wrap flex-sm-wrap flex-md-nowrap flex-lg-nowrap justify-content-xl-center align-items-xl-center flex-xl-nowrap"
             style="margin: 1em 0em;">
        ...
        <h5 class="text-Left text-sm-Left text-md-Left text-lg-Left text-xl-Left">Postcode*</h5>
        ...
        <h5 class="text-Left text-sm-Left text-md-Left text-lg-Left text-xl-Left">Plaats*</h5>
        ...
        <h5 class="text-Left text-sm-Left text-md-Left text-lg-Left text-xl-Left">Land*</h5>
        ...
        <h5 class="text-Left text-sm-Left text-md-Left text-lg-Left text-xl-Left">Gebruikersnaam*</h5>
        ...
        <h5 class="text-Left text-sm-Left text-md-Left text-lg-Left text-xl-Left">Wachtwoord*</h5>
        ...
        <h5 class="text-Left text-sm-Left text-md-Left text-lg-Left text-xl-Left">Herhaal wachtwoord*</h5>
