    ...
    <div>
        <div class="container">
              <div class="row>
                ...
                <p class = "text-center"style="color: rgb(255,255,255);margin-bottom:50px;"> Door te registreren accepteert u onze <a href="algemene_voorwaarden.php"> algemene voorwaarden.</p></a>
            </div>
        </div>
    </div>
    </div>
