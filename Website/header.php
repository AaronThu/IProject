...
?>
    ...
    <div>
        <nav class="navbar navbar-light navbar-expand-md sticky-top navigation-clean-button">
            <div class="container">
                <div><a class="navbar-brand" href="homepage.php">EenmaalAndermaal</a><span>Klik Klik Klaar</span></div>
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav d-flex justify-content-center align-items-center mr-auto">
                        ...
                        <li class="dropdown nav-item"><a class="dropdown-toggle nav-link" data-toggle="dropdown"
                            ...
                            <div class="dropdown-menu flex-column" role="menu">
                                <h6 class="dropdown-header" role="presentation">Populair</h6><a class="dropdown-item">Categorie
                                    1</a><a class="dropdown-item">Categorie 2</a><a class="dropdown-item">Categorie
                                    3</a>
                                <div class="dropdown-divider" role="presentation"></div>
                                <h6 class="dropdown-header" role="presentation">Categorieën</h6>
                                <div class="container flex-nowrap flex-sm-nowrap flex-md-wrap flex-lg-wrap flex-xl-wrap">
                                    <a class="dropdown-item" href="#">Categorie</a><a class="dropdown-item" href="#">Categoriën</a><a
                                            class="dropdown-item" href="#">Categorie</a><a class="dropdown-item"
                                                                                           href="#">Categorie</a><a
                                            class="dropdown-item" href="#">Categorie</a>
                                    <a class="dropdown-item" href="#">Categorie</a><a class="dropdown-item" href="#">Categorie</a><a
                                            class="dropdown-item" href="#">Categorie</a><a class="dropdown-item"
                                                                                           href="#">Categorie</a><a
                                            class="dropdown-item" href="#">Categorie</a><a class="dropdown-item"
                                                                                           href="#">Categorie</a><a
                                ...
                                <div class="dropdown-divider" role="presentation"></div>
                                <a class="dropdown-item" href="categorie_pagina.php">Alle Categories</a>
                            </div>
                        </li>
                    </ul>
                    ...
                    <span class="d-flex justify-content-center align-items-center navbar-text actions"> <a class="login"
                                ...
                                class="btn btn-light action-button" role="button" href="registreren_emailpagina.php">Registreer</a></span><span
                            class="d-none justify-content-center align-items-center navbar-text" id="user"> <a
                                class="btn btn-light action-button" role="button" href="#">Uitloggen</a></span>
                </div>
            </div>
        </nav>
    </div>
