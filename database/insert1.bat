...
sqlcmd -S mssql2.iproject.icasites.nl -d iproject2 -U iproject2 -P k1kQ2Ynu4M -i "Functie_HoogsteBieder.sql"
sqlcmd -S mssql2.iproject.icasites.nl -d iproject2 -U iproject2 -P k1kQ2Ynu4M -i "Functie_HoogsteBod.sql"
